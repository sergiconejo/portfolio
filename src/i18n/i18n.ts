    ...
    projects: [
      {
        ...
        subtitle:
          "Web application for personal use for a final client like TikTok / Instagram Reels.",
        ...
        desc: [
          "Includes advanced search with filters, likes, nested comments, notifications and user profile with history, saved posts and options for chnage username, email, password and delete account\n\n",
          "Authentication (username or email) and password recovery using Auth.js, Google OAuth and email verification via Nodemailer.\n\n",
          "Implements progress loading with infinite scroll, protected dashboard routes and SQLite3 database (Turso) managed with better-sqlite3.\n\n",
        ],
        cite: "Project developed individually for a final client.",
      },
      {
        title: "SM Copilot",
        subtitle:
